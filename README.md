...
<p align="center">
  ...
  <br>
  <em>Figure 1: Memory consumption comparison for an UNSAT instance. <b>Left:</b> High memory volatility and garbage collection spikes using traditional formula cloning. <b>Right:</b> Stable and highly optimized memory footprint achieved via our custom undo stack implementation.</em>
</p>
<p align="center">
  <img src="./results/SAT-UNSAT-Comparison.png" alt="SAT vs UNSAT Comparison" width="60%">
  <br>
  <em>Figure 2: Plot representing the average performance of the SAT solver across the test
